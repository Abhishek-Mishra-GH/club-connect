    ...
    const loadEvents = async () => {
      try {
        ...
        const uniqueCities: string[] = Array.from(
          ...
          fetchedEvents.find(event => event.city.toLowerCase() === cityLowerCase)!.city
        );
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container py-8 mx-auto">
        <h1 className="text-2xl sm:text-4xl font-bold mb-8 text-center">Explore Our Amazing Events</h1>
